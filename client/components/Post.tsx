...
export default function Post({ imageURI, user, timeStamp, caption, children }: PostProps) {
    return (
        <div style={{ color: 'fff' }}>
            <Card>
                <AuthorWrapper>
                    <UserIconCropper>
                        <UserIconPhoto src="https://images2.minutemediacdn.com/image/upload/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/shape/cover/sport/643219-gettyimages-1248993201-d7df1ac598521e38e548ac9e02000b76.jpg" />
                    </UserIconCropper>
                    <Date>{timeStamp}</Date>
                    <Date>{user}</Date>
                </AuthorWrapper>
